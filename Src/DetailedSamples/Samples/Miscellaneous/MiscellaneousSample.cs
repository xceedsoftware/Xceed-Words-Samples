...
#if !OPEN_SOURCE
        var bulletsList = document.AddList( new ListOptions() { ListType = ListItemType.Bulleted } );
        bulletsList.AddListItem( "2 cups of flour" );
        bulletsList.AddListItem( "3⁄4 cup of sugar" );
        bulletsList.AddListItem( "1⁄2 cup of butter" );
        bulletsList.AddListItem( "2 eggs" );
        bulletsList.AddListItem( "1 cup of milk" );
        bulletsList.AddListItem( "2 teaspoons of baking powder" );
        bulletsList.AddListItem( "1⁄2 teaspoon of salt" );
        bulletsList.AddListItem( "1 teaspoon of vanilla essence" );
#else
...
#if !OPEN_SOURCE
        var recipeList = document.AddList( new ListOptions() );
        recipeList.AddListItem( "Preheat oven to 375F and fill muffin cups with papers." );
        recipeList.AddListItem( "Mix butter and sugar until light and fluffy." );
        recipeList.AddListItem( "Beat in the eggs, one at a time.", 1 );
        recipeList.AddListItem( "Add the flour, baking powder and salt, alternate with milk and beat well." );
        recipeList.AddListItem( "Add in vanilla.", 1 );
        recipeList.AddListItem( "Divide in the pans and bake for 18 minutes." );
        recipeList.AddListItem( "Let cool 5 minutes an eat.", 1 );
#else

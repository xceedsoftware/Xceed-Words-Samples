...
namespace Xceed.WinForm.Words.Sample
{
	public partial class Form1 : Form
	{
        ...
        private void button1_Click( object sender, EventArgs e )
		{
			...
			{
				GenerateSimpleDocument( saveFileDialog.FileName );
			}
		}
		...
		private void button2_Click( object sender, EventArgs e )
		{
			...
			if( saveFileDialog.ShowDialog() == DialogResult.OK )
			{
				GenerateListDocument( saveFileDialog.FileName );
			}
		}
		...
		private void button3_Click( object sender, EventArgs e )
		{
			...
			if( saveFileDialog.ShowDialog() == DialogResult.OK )
			{
				GenerateTableDocument( saveFileDialog.FileName );
			}
		}

		private void GenerateSimpleDocument( string filePath )
		{
		...
		private void GenerateListDocument( string filePath )
		{
			var doc = DocX.Create( filePath );
		...
		private void GenerateTableDocument( string filePath )
		{
			var doc = DocX.Create( filePath );

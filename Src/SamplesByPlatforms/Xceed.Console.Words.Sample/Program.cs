...
void GenerateSimpleDocument()
{
	string filePath = "SimpleDocument.docx";
	var doc = DocX.Create( filePath );

	doc.InsertParagraph( "The History of Intel" ).FontSize( 18 ).Bold().Alignment = Xceed.Document.NET.Alignment.center;
	...
	doc.InsertParagraph( "The History of Apple" ).FontSize( 18 ).Bold().Alignment = Xceed.Document.NET.Alignment.center;
	...
	doc.InsertParagraph( "The History of Tesla" ).FontSize( 18 ).Bold().Alignment = Xceed.Document.NET.Alignment.center;
...
{
	string filePath = "ListDocument.docx";
	var doc = DocX.Create( filePath );

	doc.InsertParagraph( "How to Make Cuban Moros y Cristianos" ).FontSize( 18 ).Bold()
...
{
	string filePath = "TableDocument.docx";
	var doc = DocX.Create( filePath );
	doc.InsertParagraph( "Technical Specifications of a High-Performance Laptop" ).FontSize( 18 )
			.Bold()
			.Alignment = Xceed.Document.NET.Alignment.center;
